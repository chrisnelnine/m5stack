...
void loop() {
  ...
  if (sht3x.update()) {
    ...
    float pressure = bmp.pressure;  // in Pa
    float altitude = bmp.altitude;  // in meters
    ...
    M5.Display.drawString(tempStr, M5.Display.width() / 2, M5.Display.height() / 2 - 40);
    M5.Display.drawString(humidityStr, M5.Display.width() / 2, M5.Display.height() / 2);
    M5.Display.drawString(pressureStr, M5.Display.width() / 2, M5.Display.height() / 2 + 40);
    M5.Display.drawString(altitudeStr, M5.Display.width() / 2, M5.Display.height() / 2 + 80);
  } else {
    M5.Display.fillScreen(TFT_BLACK);
